...
class DomainServiceApi
{
     ...
     */
    public function deleteDomain($id, $reseller_id = null, $domain_name = null, $domain_extension = null, $domain_idn_extension = null, $type = null, $skip_soft_quarantine = null)
    {
        list($response) = $this->deleteDomainWithHttpInfo($id, $reseller_id, $domain_name, $domain_extension, $domain_idn_extension, $type, $skip_soft_quarantine);
        return $response;
    }
     ...
     */
    public function deleteDomainWithHttpInfo($id, $reseller_id = null, $domain_name = null, $domain_extension = null, $domain_idn_extension = null, $type = null, $skip_soft_quarantine = null)
    {
        $request = $this->deleteDomainRequest($id, $reseller_id, $domain_name, $domain_extension, $domain_idn_extension, $type, $skip_soft_quarantine);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDomainAsync($id, $reseller_id = null, $domain_name = null, $domain_extension = null, $domain_idn_extension = null, $type = null, $skip_soft_quarantine = null)
    {
        return $this->deleteDomainAsyncWithHttpInfo($id, $reseller_id, $domain_name, $domain_extension, $domain_idn_extension, $type, $skip_soft_quarantine)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDomainAsyncWithHttpInfo($id, $reseller_id = null, $domain_name = null, $domain_extension = null, $domain_idn_extension = null, $type = null, $skip_soft_quarantine = null)
    {
        $returnType = '\Openprovider\Api\Rest\Client\Domain\Model\DomainDeleteDomainResponse';
        $request = $this->deleteDomainRequest($id, $reseller_id, $domain_name, $domain_extension, $domain_idn_extension, $type, $skip_soft_quarantine);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteDomainRequest($id, $reseller_id = null, $domain_name = null, $domain_extension = null, $domain_idn_extension = null, $type = null, $skip_soft_quarantine = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($domain_idn_extension !== null) {
            $queryParams['domain.idn_extension'] = ObjectSerializer::toQueryValue($domain_idn_extension);
        }
        // query params
        if ($type !== null) {
     ...
     * @param  bool $with_registry_details Retrurns registry details. (optional)
     ...
     */
    public function getDomain($id, $domain_name = null, $domain_extension = null, $domain_idn_extension = null, $reseller_id = null, $queue_status = null, $with_history = null, $with_api_history = null, $with_additional_data = null, $with_registry_details = null, $with_dnssec_data = null, $with_abuse_details = null, $with_whois_privacy_data = null, $with_registry_statuses = null, $is_deleted = null)
    {
        list($response) = $this->getDomainWithHttpInfo($id, $domain_name, $domain_extension, $domain_idn_extension, $reseller_id, $queue_status, $with_history, $with_api_history, $with_additional_data, $with_registry_details, $with_dnssec_data, $with_abuse_details, $with_whois_privacy_data, $with_registry_statuses, $is_deleted);
        return $response;
    }
     ...
     */
    public function getDomainWithHttpInfo($id, $domain_name = null, $domain_extension = null, $domain_idn_extension = null, $reseller_id = null, $queue_status = null, $with_history = null, $with_api_history = null, $with_additional_data = null, $with_registry_details = null, $with_dnssec_data = null, $with_abuse_details = null, $with_whois_privacy_data = null, $with_registry_statuses = null, $is_deleted = null)
    {
        $request = $this->getDomainRequest($id, $domain_name, $domain_extension, $domain_idn_extension, $reseller_id, $queue_status, $with_history, $with_api_history, $with_additional_data, $with_registry_details, $with_dnssec_data, $with_abuse_details, $with_whois_privacy_data, $with_registry_statuses, $is_deleted);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDomainAsync($id, $domain_name = null, $domain_extension = null, $domain_idn_extension = null, $reseller_id = null, $queue_status = null, $with_history = null, $with_api_history = null, $with_additional_data = null, $with_registry_details = null, $with_dnssec_data = null, $with_abuse_details = null, $with_whois_privacy_data = null, $with_registry_statuses = null, $is_deleted = null)
    {
        return $this->getDomainAsyncWithHttpInfo($id, $domain_name, $domain_extension, $domain_idn_extension, $reseller_id, $queue_status, $with_history, $with_api_history, $with_additional_data, $with_registry_details, $with_dnssec_data, $with_abuse_details, $with_whois_privacy_data, $with_registry_statuses, $is_deleted)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDomainAsyncWithHttpInfo($id, $domain_name = null, $domain_extension = null, $domain_idn_extension = null, $reseller_id = null, $queue_status = null, $with_history = null, $with_api_history = null, $with_additional_data = null, $with_registry_details = null, $with_dnssec_data = null, $with_abuse_details = null, $with_whois_privacy_data = null, $with_registry_statuses = null, $is_deleted = null)
    {
        $returnType = '\Openprovider\Api\Rest\Client\Domain\Model\DomainGetDomainResponse';
        $request = $this->getDomainRequest($id, $domain_name, $domain_extension, $domain_idn_extension, $reseller_id, $queue_status, $with_history, $with_api_history, $with_additional_data, $with_registry_details, $with_dnssec_data, $with_abuse_details, $with_whois_privacy_data, $with_registry_statuses, $is_deleted);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getDomainRequest($id, $domain_name = null, $domain_extension = null, $domain_idn_extension = null, $reseller_id = null, $queue_status = null, $with_history = null, $with_api_history = null, $with_additional_data = null, $with_registry_details = null, $with_dnssec_data = null, $with_abuse_details = null, $with_whois_privacy_data = null, $with_registry_statuses = null, $is_deleted = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($with_registry_details !== null) {
            $queryParams['with_registry_details'] = ObjectSerializer::toQueryValue($with_registry_details);
        }
        // query params
     ...
     * @param  bool $with_document_list With document list. (optional)
     ...
     * @param  bool $with_verification_email With verification email. (optional)
     * @param  bool $with_registry_statuses Indicates, if registry EPP statuses should be retrieved. (optional)
     ...
     */
    public function listDomains($order_by_id = null, $order_by_domain_name = null, $order_by_domain_extension = null, $order_by_order_date = null, $order_by_active_date = null, $order_by_expiration_date = null, $order_by_renewal_date = null, $order_by_status = null, $order_by_transfer_date = null, $limit = null, $offset = null, $id = null, $extension = null, $renewal_date = null, $domain_name_pattern = null, $ns_group_pattern = null, $status = null, $status_not_equal = null, $queue_status = null, $contact_handle = null, $comment_pattern = null, $with_history = null, $with_api_history = null, $with_document_list = null, $with_additional_data = null, $application_mode = null, $with_verification_email = null, $with_registry_statuses = null, $response_to = null, $is_deleted = null)
    {
    ...
    protected function listDomainsRequest($order_by_id = null, $order_by_domain_name = null, $order_by_domain_extension = null, $order_by_order_date = null, $order_by_active_date = null, $order_by_expiration_date = null, $order_by_renewal_date = null, $order_by_status = null, $order_by_transfer_date = null, $limit = null, $offset = null, $id = null, $extension = null, $renewal_date = null, $domain_name_pattern = null, $ns_group_pattern = null, $status = null, $status_not_equal = null, $queue_status = null, $contact_handle = null, $comment_pattern = null, $with_history = null, $with_api_history = null, $with_document_list = null, $with_additional_data = null, $application_mode = null, $with_verification_email = null, $with_registry_statuses = null, $response_to = null, $is_deleted = null)
    {
        ...
        // query params
        if ($with_document_list !== null) {
            $queryParams['with_document_list'] = ObjectSerializer::toQueryValue($with_document_list);
        }
        // query params
        if ($with_additional_data !== null) {
            $queryParams['with_additional_data'] = ObjectSerializer::toQueryValue($with_additional_data);
